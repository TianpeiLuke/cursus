...
This pipeline implements a MODS-enhanced version of the complete XGBoost end-to-end workflow:
...
Example:
    ```python
    from cursus.pipeline_catalog.mods_frameworks.xgboost.end_to_end.complete_e2e_mods import create_pipeline
...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.info("Please install MODS or use the standard XGBoost complete end-to-end pipeline instead")
    except Exception as e:
