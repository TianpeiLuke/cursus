...
Example:
    ```python
    from cursus.pipeline_catalog.mods_frameworks.xgboost.training.with_calibration_mods import create_pipeline
...
def create_pipeline(
    ...
    if pipeline_name:
        ...
        dag_compiler.pipeline_name = "MODS-XGBoost-Training-Calibration-Pipeline"
...
if __name__ == "__main__":
    ...
    try:
        ...
        pipeline, report, dag_compiler, mods_template = create_pipeline(
            ...
            session=pipeline_session,
            role=role,
            pipeline_name="MODS-XGBoost-Training-Calibration-Pipeline",
        ...
        #     pipeline=pipeline, 
        #     document={"training_dataset": "my-dataset", "calibration_dataset": "my-cal-dataset"}, 
        ...
        logger.info("Please install MODS or use the standard XGBoost training with calibration pipeline instead")
    except Exception as e:
