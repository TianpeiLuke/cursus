...
def create_pipeline(
    ...
    if pipeline_name:
        ...
        dag_compiler.pipeline_name = "MODS-XGBoost-Simple-Pipeline"
...
if __name__ == "__main__":
    ...
    try:
        ...
        pipeline, report, dag_compiler, mods_template = create_pipeline(
            ...
            session=pipeline_session,
            role=role,
            pipeline_name="MODS-XGBoost-Simple-Pipeline",
        ...
        logger.info("Please install MODS or use the standard XGBoost simple pipeline instead")
    except Exception as e:
