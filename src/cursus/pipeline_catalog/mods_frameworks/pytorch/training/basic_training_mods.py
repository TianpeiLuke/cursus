...
Example:
    ```python
    from cursus.pipeline_catalog.mods_frameworks.pytorch.training.basic_training_mods import create_pipeline
...
def create_pipeline(
    ...
    if pipeline_name:
        ...
        dag_compiler.pipeline_name = "MODS-PyTorch-Basic-Training-Pipeline"
...
if __name__ == "__main__":
    ...
    try:
        ...
        pipeline, report, dag_compiler, mods_template = create_pipeline(
            ...
            session=pipeline_session,
            role=role,
            pipeline_name="MODS-PyTorch-Basic-Training-Pipeline",
        ...
        logger.info("Please install MODS or use the standard PyTorch basic training pipeline instead")
    except Exception as e:
