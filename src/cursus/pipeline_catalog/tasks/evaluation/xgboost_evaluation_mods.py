"""
MODS XGBoost Evaluation Pipeline (Task-based View)

This is a reference to the MODS-enhanced XGBoost training pipeline with evaluation from the mods_frameworks directory.
...
from ...mods_frameworks.xgboost.training.with_evaluation_mods import (
    create_dag,
    create_pipeline,
