...
class ImportResolver:
    ...
    def _try_relative_import_pattern(cls) -> bool:
        ...
        try:
            ...
            module = importlib.import_module(
                "..validation.alignment.unified_alignment_tester", package=__package__
            )
    ...
    def _try_step_catalog_discovery(cls) -> bool:
        ...
        try:
            ...
            if len(available_steps) > 0:
                ...
                logger.debug(
                    f"StepCatalog discovery successful with {len(available_steps)} steps"
                )
                return True
            else:
    ...
    def get_project_info(cls) -> dict:
        ...
        return {
            ...
            "sys_path_entries": [
                path for path in sys.path if "cursus" in path or "src" in path
            ],
        }
