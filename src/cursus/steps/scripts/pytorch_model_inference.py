    ...
    if numerical_fields:
        ...
        try:
            validate_numerical_fields(
                bsm_dataset.DataReader, numerical_fields, "inference"
            )
    ...
    if categorical_fields:
        ...
        try:
            validate_categorical_fields(
                bsm_dataset.DataReader, categorical_fields, "inference"
            )
...
def preprocess_inference_data(
    ...
    bsm_dataset = create_bsm_dataset(config, inference_data_dir, filename)
