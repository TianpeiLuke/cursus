...
class LightGBMMTModelEvalStepBuilder(StepBuilderBase):
    ...
    def _get_environment_variables(self) -> Dict[str, str]:
        ...
        These variables are used to control the behavior of the multi-task evaluation script
        ...
        # This controls which PyPI source the evaluation script uses for package installation
        ...
        # Add multi-task evaluation-specific environment variables
