...
class WorkspaceAPI:
    ...
    def __init__(self, workspace_dirs: Optional[Union[Path, List[Path]]] = None):
        ...
        logger.info(
            f"WorkspaceAPI initialized with {len(self.workspace_dirs)} workspace directories"
        )
    ...
    def validate_workspace_components(self, workspace_id: str) -> ValidationResult:
        ...
        try:
            self.metrics["api_calls"] += 1
            validation_result = self.validator.validate_workspace_components(
                workspace_id
            )
    ...
    def validate_cross_workspace_compatibility(
        ...
        try:
            ...
            compatibility_result = (
                self.validator.validate_cross_workspace_compatibility(workspace_ids)
            )
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            status = {
                ...
                "catalog": self.catalog.get_metrics_report()
            ...
            return {"error": str(e), "workspace_api": {"metrics": self.metrics.copy()}}
    ...
    def get_workspace_component_count(self, workspace_id: str) -> int:
        ...
        try:
            ...
            logger.error(
                f"Error getting component count for workspace {workspace_id}: {e}"
            )
            return 0

    def is_component_available(
        self, step_name: str, workspace_id: Optional[str] = None
    ) -> bool:
        """
