...
class TypeAwareConfigSerializer:
    ...
    def __init__(
        ...
        # Use the UnifiedConfigManager's simple tracker for circular reference detection
    ...
    def deserialize(
        ...
        is_circular = self.unified_manager.simple_tracker.enter_object(field_data, field_name)
        error = f"Circular reference detected in {field_name}" if is_circular else None
        ...
        try:
            ...
            self.unified_manager.simple_tracker.exit_object()
