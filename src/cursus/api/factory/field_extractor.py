        ...
        if fields is not None:
            for field_name, field_info in fields.items():
                    ...
                    if (
                        ...
                        try:
                            ...
                            factory_name = getattr(
                                field_info.default_factory, "__name__", "unknown"
                            )
                ...
                if hasattr(field_info, "description") and field_info.description:
                    ...
                    description = field_info.json_schema_extra.get(
...
def extract_non_inherited_fields(
    derived_class: Type[BaseModel], base_class: Type[BaseModel]
) -> List[Dict[str, Any]]:
    """
...
def categorize_field_requirements(
