...
from buyer_abuse_mods_template.cursus.core.compiler.dag_compiler import (
    PipelineDAGCompiler,
)
...
DEFAULT_REGION = "NA"
DEFAULT_SERVICE_NAME = "Names3Risk"

# Define constants
AUTHOR = "lukexie"
PIPELINE_VERSION = "1.0.0"
PIPELINE_DESCRIPTION = "Pytorch Training Pipeline for Names3Risk Model"
...
class Names3RiskPipelineNA:
    ...
    def __init__(
        ...
        pipeline_config_name = f"config_{regional_alias}.json"
        ...
        # Create XGBoost DAG
        self.dag = create_pytorch_e2e_training_dag()
        logger.info(
