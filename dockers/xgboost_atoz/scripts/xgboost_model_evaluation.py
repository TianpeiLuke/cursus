...
def compute_metrics_multiclass(y_true, y_prob, n_classes):
    ...
    metrics["average_precision_macro"] = average_precision_score(y_true_bin, y_prob, average="macro")
    metrics["average_precision_micro"] = average_precision_score(y_true_bin, y_prob, average="micro")
