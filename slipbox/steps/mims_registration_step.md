...
- It takes the packaged model from the [MIMS Packaging Step](packaging_step.md) as a required input
- It takes the test payloads from the [MIMS Payload Step](payload_step.md) as an optional input
...
- [MIMS Payload Step](payload_step.md): Generates test payloads for the model
