...
| **Container entry point** | `lightgbmmt_model_eval.py` |
| **Interface file** | `steps/interfaces/lightgbmmt_model_eval.step.yaml` |
...
|-------|------|----------|----------------------|
| `model_input` | `model_artifacts` | yes | [LightGBMMTTraining](lightgbmmt_training.md), [LightGBMTraining](lightgbm_training.md), LightGBMMTModel, LightGBMModel, [DummyTraining](dummy_training.md) |
