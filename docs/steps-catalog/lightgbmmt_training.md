...
| **Container entry point** | `lightgbmmt_training.py` |
| **Interface file** | `steps/interfaces/lightgbmmt_training.step.yaml` |
...
| `model_artifacts_input` | `processing_output` | no | [LightGBMMTTraining](lightgbmmt_training.md), [MissingValueImputation](missing_value_imputation.md), [RiskTableMapping](risk_table_mapping.md), [FeatureSelection](feature_selection.md) |
