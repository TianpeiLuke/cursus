...
| **Container entry point** | `xgboost_model_inference.py` |
| **Interface file** | `steps/interfaces/xgboost_model_inference.step.yaml` |
...
|-------|------|----------|----------------------|
| `model_input` | `model_artifacts` | yes | [XGBoostTraining](xgboost_training.md), [PyTorchTraining](pytorch_training.md), [DummyTraining](dummy_training.md), [XGBoostModel](xgboost_model.md), [PyTorchModel](pytorch_model.md), [PyTorchModelInference](pytorch_model_inference.md) |
