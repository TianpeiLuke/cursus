...
latex_documents = [
    (master_doc, "cursus.tex", "Cursus Documentation", "Tianpei Xie", "manual"),
]
...
man_pages = [(master_doc, "cursus", "Cursus Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "cursus",
        "Automatic SageMaker Pipeline Generation",
        "Miscellaneous",
    ),
]
