...
class TestValidateCommand:
    ...
    def test_validate_script_success(self, mock_tester_class, cli_runner):
        ...
        mock_tester.validate_specific_script.assert_called_once_with(
            "currency_conversion"
        )
    ...
    @patch("cursus.cli.alignment_cli.UnifiedAlignmentTester")
    def test_validate_script_with_workspace_dirs(
        self, mock_tester_class, cli_runner, temp_dir
    ):
        ...
        result = cli_runner.invoke(
            validate, ["currency_conversion", "--workspace-dirs", temp_dir]
        )

        assert result.exit_code == 0
        mock_tester_class.assert_called_once_with(workspace_dirs=[temp_dir])
    ...
    def test_validate_script_verbose_output(self, mock_tester_class, cli_runner):
        ...
        result = cli_runner.invoke(validate, ["currency_conversion", "--verbose"])
    ...
    def test_validate_script_with_scoring(self, mock_tester_class, cli_runner):
        ...
        result = cli_runner.invoke(validate, ["currency_conversion", "--show-scoring"])
    ...
    def test_validate_script_json_output(self, mock_tester_class, cli_runner, temp_dir):
        ...
        result = cli_runner.invoke(
            validate,
            ["currency_conversion", "--output-dir", temp_dir],
        )
...
class TestValidateAllCommand:
    ...
    @patch("cursus.cli.alignment_cli.UnifiedAlignmentTester")
    def test_validate_all_scripts_with_continue_on_error(
        self, mock_tester_class, cli_runner
    ):
    ...
    @patch("cursus.cli.alignment_cli.UnifiedAlignmentTester")
    def test_validate_all_scripts_json_output(
        self, mock_tester_class, cli_runner, temp_dir
    ):
        ...
        result = cli_runner.invoke(validate_all, ["--output-dir", temp_dir])
...
class TestValidateLevelCommand:
    ...
    def test_validate_level_failure(self, mock_tester_class, cli_runner):
        ...
        result = cli_runner.invoke(
            validate_level, ["currency_conversion", "1", "--verbose"]
        )
    ...
    def test_validate_level_invalid_level(self, cli_runner):
        ...
        result = cli_runner.invoke(validate_level, ["currency_conversion", "5"])
...
class TestListScriptsCommand:
    ...
    @patch("cursus.cli.alignment_cli.UnifiedAlignmentTester")
    def test_list_scripts_with_workspace_dirs(
        self, mock_tester_class, cli_runner, temp_dir
    ):
        ...
        result = cli_runner.invoke(list_scripts, ["--workspace-dirs", temp_dir])
