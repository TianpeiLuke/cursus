...
""")
    ...
    def test_discover_config_classes_with_workspace(
        self, temp_workspace, config_discovery
    ):
...
""")
    ...
    def test_discover_config_classes_workspace_override(
        self, temp_workspace, config_discovery
    ):
...
""")
    ...
    def test_build_complete_config_classes_with_store(self, config_discovery):
        ...
        with patch.object(config_discovery, "discover_config_classes") as mock_discover:
            ...
            with patch.object(
                config_discovery, "discover_hyperparameter_classes"
            ) as mock_discover_hyper:
    ...
    def test_build_complete_config_classes_import_error(self, config_discovery):
        ...
        with patch.object(config_discovery, "discover_config_classes") as mock_discover:
            ...
            with patch(
                "cursus.step_catalog.config_discovery.importlib.import_module",
                side_effect=ImportError("ConfigClassStore not found"),
            ):
                result = config_discovery.build_complete_config_classes()
    ...
    def test_logging_behavior(self, config_discovery):
        ...
        with patch.object(config_discovery.logger, "info") as mock_info:
            with patch.object(config_discovery.logger, "error") as mock_error:
                ...
                with patch.object(
                    config_discovery, "_scan_config_directory"
                ) as mock_scan:
...
"""
    ...
    def test_module_path_conversion_realistic(self):
        ...
        cursus_path = Path(
            "/workspace/src/cursus/steps/configs/config_training_step.py"
        )
        ...
        workspace_path = Path(
            "/workspace/development/projects/alpha/src/cursus_dev/steps/configs/custom_config.py"
        )
