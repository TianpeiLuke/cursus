...
class TestConfigClassDetectorAdapter:
    ...
    def test_init_without_workspace(self):
        ...
        with patch(
            "cursus.step_catalog.adapters.config_class_detector.StepCatalog"
        ) as mock_catalog:
    ...
    def test_extract_class_names_from_metadata(self):
        ...
        config_data = {
            "metadata": {
                "config_types": {"step1": "TestConfig1", "step2": "TestConfig2"}
            }
        }

        mock_logger = Mock()
        result = ConfigClassDetectorAdapter._extract_class_names(
            config_data, mock_logger
        )
    ...
    def test_extract_class_names_from_configuration(self):
        ...
        config_data = {
            "configuration": {
                "specific": {
                    "step1": {"__model_type__": "TestConfig1"},
                    "step2": {"__model_type__": "TestConfig2"},
                }
            }
        }
    ...
    def test_extract_class_names_combined_sources(self):
        ...
        config_data = {
            "metadata": {"config_types": {"step1": "MetadataConfig"}},
            "configuration": {
                "specific": {"step2": {"__model_type__": "ConfigurationConfig"}}
            },
        }
    ...
    def test_extract_class_names_error_handling(self):
        ...
        config_data["metadata"] = (
            "trigger_error"  # This will cause exception when accessed
        )
...
class TestConfigClassStoreAdapter:
    ...
    def test_register_class_overwrite_warning(self):
        ...
        with patch.object(ConfigClassStoreAdapter._logger, "warning") as mock_warning:
            ...
            assert (
                "already registered and is being overwritten"
