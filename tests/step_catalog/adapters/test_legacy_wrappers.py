...
class TestLegacyDiscoveryWrapper:
    ...
    def test_init(self, temp_workspace):
        ...
        with patch(
            "cursus.step_catalog.adapters.legacy_wrappers.StepCatalog"
        ) as mock_catalog:
            with patch(
                "cursus.step_catalog.adapters.legacy_wrappers.ContractDiscoveryEngineAdapter"
            ) as mock_contract_engine:
                with patch(
                    "cursus.step_catalog.adapters.legacy_wrappers.ContractDiscoveryManagerAdapter"
                ) as mock_contract_manager:
                    with patch(
                        "cursus.step_catalog.adapters.legacy_wrappers.FlexibleFileResolverAdapter"
                    ) as mock_file_resolver:
                        with patch(
                            "cursus.step_catalog.adapters.legacy_wrappers.WorkspaceDiscoveryManagerAdapter"
                        ) as mock_workspace_manager:
                            with patch(
                                "cursus.step_catalog.adapters.legacy_wrappers.HybridFileResolverAdapter"
                            ) as mock_hybrid_resolver:
                                ...
                                mock_contract_engine.assert_called_once_with(
                                    temp_workspace
                                )
                                mock_contract_manager.assert_called_once_with(
                                    temp_workspace
                                )
                                mock_file_resolver.assert_called_once_with(
                                    temp_workspace
                                )
                                mock_workspace_manager.assert_called_once_with(
                                    temp_workspace
                                )
                                mock_hybrid_resolver.assert_called_once_with(
                                    temp_workspace
                                )
    ...
    def test_refresh_cache_success(self, temp_workspace):
        ...
        with patch(
            ...
            mock_step_info2.file_components = {"spec": mock_spec2}
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                assert (
                                    wrapper._extract_base_name(
                                        "XGBoostTraining", "script"
                                    )
                                    == "x_g_boost_training"
                                )
                                assert (
                                    wrapper._extract_base_name(
                                        "DataLoading", "contract"
                                    )
                                    == "data_loading"
                                )
                                assert (
                                    wrapper._extract_base_name("SimpleStep", "spec")
                                    == "simple_step"
                                )
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                assert (
                                    wrapper._normalize_name("test-name") == "test_name"
                                )
                                assert (
                                    wrapper._normalize_name("test.name") == "test_name"
                                )
                                assert (
                                    wrapper._normalize_name("preprocess")
                                    == "preprocessing"
                                )
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                assert (
                                    wrapper._calculate_similarity("test", "test") == 1.0
                                )
                                assert (
                                    wrapper._calculate_similarity("test", "TEST") == 1.0
                                )
                                assert (
                                    wrapper._calculate_similarity("test", "testing")
                                    > 0.5
                                )
                                assert (
                                    wrapper._calculate_similarity(
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                mock_catalog.get_step_info.assert_called_with(
                                    "test_step"
                                )
    ...
    def test_find_best_match_fuzzy_matching(self, temp_workspace):
        ...
        with patch(
            ...
            mock_catalog.get_step_info.side_effect = [
                None,
                None,
                None,
                mock_step_info,
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                wrapper = LegacyDiscoveryWrapper(temp_workspace)
                                result = wrapper._find_best_match(
                                    "xgboost_training", "script"
                                )
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                assert (
                                    wrapper.extract_base_name_from_spec(
                                        Path("test_step_spec.py")
                                    )
                                    == "test_step"
                                )
                                assert (
                                    wrapper.extract_base_name_from_spec(
                                        Path("xgboost_training_spec.py")
                                    )
                                    == "xgboost_training"
                                )
                                assert (
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                with patch.object(
                                    wrapper,
                                    "find_spec_file",
                                    return_value="/path/to/test_step_spec.py",
                                ):
                                    result = wrapper.find_spec_constant_name(
                                        "test_step"
                                    )
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                with patch.object(
                                    wrapper, "find_spec_file", return_value=None
                                ):
                                    result = wrapper.find_spec_constant_name(
                                        "test_step"
                                    )
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                with patch.object(
                                    wrapper,
                                    "find_spec_file",
                                    return_value="/path/to/spec.py",
                                ):
                                    result = wrapper.find_specification_file(
                                        "test_step"
                                    )
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                mock_catalog.find_step_by_component.assert_called_with(
                                    "test_component"
                                )

                                wrapper.list_available_steps()
                                mock_catalog.list_available_steps.assert_called_with(
                                    None, None
                                )

                                wrapper.search_steps("test_query")
                                mock_catalog.search_steps.assert_called_with(
                                    "test_query", None
                                )

                                wrapper.discover_config_classes()
                                mock_catalog.discover_config_classes.assert_called_with(
                                    None
                                )

                                wrapper.build_complete_config_classes()
                                mock_catalog.build_complete_config_classes.assert_called_with(
                                    None
                                )

                                wrapper.get_job_type_variants("test_step")
                                mock_catalog.get_job_type_variants.assert_called_with(
                                    "test_step"
                                )
                                ...
                                mock_catalog.detect_framework.assert_called_with(
                                    "test_step"
                                )

                                wrapper.discover_cross_workspace_components()
                                mock_catalog.discover_cross_workspace_components.assert_called_with(
                                    None
                                )

                                wrapper.get_builder_class_path("test_step")
                                mock_catalog.get_builder_class_path.assert_called_with(
                                    "test_step"
                                )

                                wrapper.load_builder_class("test_step")
                                mock_catalog.load_builder_class.assert_called_with(
                                    "test_step"
                                )
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                assert (
                                    wrapper.get_adapter("contract_discovery_engine")
                                    == wrapper.contract_discovery_engine
                                )
                                assert (
                                    wrapper.get_adapter("contract_discovery_manager")
                                    == wrapper.contract_discovery_manager
                                )
                                assert (
                                    wrapper.get_adapter("flexible_file_resolver")
                                    == wrapper.flexible_file_resolver
                                )
                                assert (
                                    wrapper.get_adapter("workspace_discovery_manager")
                                    == wrapper.workspace_discovery_manager
                                )
                                assert (
                                    wrapper.get_adapter("hybrid_file_resolver")
                                    == wrapper.hybrid_file_resolver
                                )

                                # Test getting non-existent adapter
                                assert (
                                    wrapper.get_adapter("nonexistent_adapter") is None
                                )
...
class TestLegacyFunctions:
    ...
    def test_build_complete_config_classes_success(self):
        ...
        mock_config_classes = {"TestConfig": Mock(), "AnotherConfig": Mock()}
        ...
        with patch(
            ...
            mock_catalog.build_complete_config_classes.assert_called_once_with(
                "test_project"
            )
    ...
    def test_build_complete_config_classes_error_fallback(self):
        ...
        with patch(
            ...
            with patch(
                "cursus.step_catalog.adapters.legacy_wrappers.ConfigClassStoreAdapter"
            ) as mock_store:
    ...
    def test_detect_config_classes_from_json(self):
        ...
        with patch(
            "cursus.step_catalog.adapters.legacy_wrappers.ConfigClassDetectorAdapter"
        ) as mock_detector:
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                contract_file = wrapper.find_contract_file(
                                    "XGBoostTraining"
                                )
                                spec_file = wrapper.find_spec_file("XGBoostTraining")
                                builder_file = wrapper.find_builder_file(
                                    "XGBoostTraining"
                                )
                                all_files = wrapper.find_all_component_files(
                                    "XGBoostTraining"
                                )
                                report = wrapper.get_available_files_report()
                                ...
                                assert contract_file == Path(
                                    "/path/to/xgboost_training_contract.py"
                                )
                                assert spec_file == Path(
                                    "/path/to/xgboost_training_spec.py"
                                )
                                assert builder_file == Path(
                                    "/path/to/xgboost_training_builder.py"
                                )
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                with pytest.raises(
                                    Exception, match="Catalog initialization failed"
                                ):
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                assert (
                                    wrapper._normalize_name("test-name.with_eval")
                                    == "test_name_with_evaluation"
                                )
