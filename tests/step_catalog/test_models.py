...
class TestFileMetadata:
    ...
    def test_file_metadata_creation(self):
        ...
        metadata = FileMetadata(
            path=path, file_type="script", modified_time=modified_time
        )
...
class TestStepInfo:
    ...
    def test_step_info_properties(self):
        ...
        step_info = StepInfo(
            step_name="test_step", workspace_id="core", registry_data=registry_data
        )
    ...
    def test_step_info_defaults(self):
        ...
        step_info = StepInfo(step_name="test_step", workspace_id="core")
...
class TestModelIntegration:
    ...
    def test_search_result_with_step_info_components(self):
        ...
        assert set(search_result.components_available) == set(
            step_info.file_components.keys()
        )
