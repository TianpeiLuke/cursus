...
class TestPipelineTemplateBase:
    ...
    def test_init_loads_raw_config_data(
        ...
        with (
            ...
            assert (
                template.loaded_config_data["Base"]["config_type"]
                == "BasePipelineConfig"
            )

    def test_init_handles_config_loading_error(
    ...
    def test_load_configs_validates_config_classes(self, temp_config_file):
        ...
        with pytest.raises(
            ValueError, match="CONFIG_CLASSES must be defined by subclass"
        ):
            EmptyConfigTemplate(config_path=temp_config_file)

    def test_configs_access_base_configuration(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
    ...
    def test_initialization_handles_missing_base_config(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
    ...
    def test_initialize_components_creates_components_when_missing(
    ...
    def test_set_pipeline_parameters_stores_parameters(
        self,
        temp_config_file,
        pipeline_parameters,
        mock_registry_manager,
    ...
    def test_get_pipeline_parameters_returns_stored_parameters(
        self,
        temp_config_file,
        pipeline_parameters,
        mock_registry_manager,
    ...
    def test_get_pipeline_parameters_returns_empty_list_when_none_stored(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
    ...
    def test_get_pipeline_name_uses_rule_based_generator(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
    ...
    def test_store_pipeline_metadata_stores_step_instances(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
    ...
    def test_build_with_context_class_method(self, mock_context, temp_config_file):
        ...
        with (
            patch.object(
                ConcretePipelineTemplate, "generate_pipeline"
            ) as mock_generate,
            patch("cursus.steps.configs.utils.load_configs") as mock_load_configs,
        ):
            mock_base_config = MockConfig()
            ...
            result = ConcretePipelineTemplate.build_with_context(
                config_path=temp_config_file
            )
    ...
    def test_build_in_thread_class_method(
        ...
        with (
            ...
            result = ConcretePipelineTemplate.build_in_thread(
                config_path=temp_config_file
            )
    ...
    def test_validate_configuration_abstract_method_called(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
        ...
        with (
            ...
            with (
                patch.object(
                    ...
                    wraps=template._create_pipeline_dag,
                ) as mock_dag,
                patch.object(
                    template, "_create_config_map", wraps=template._create_config_map
                ) as mock_config_map,
                patch.object(
                    template,
                    "_create_step_builder_map",
                    wraps=template._create_step_builder_map,
                ) as mock_builder_map,
            ):
    ...
    def test_error_handling_in_generate_pipeline(
        ...
        with (
            ...
            with patch.object(
                template,
                "_create_pipeline_dag",
                side_effect=Exception("DAG creation failed"),
            ):
    ...
    def test_step_catalog_provided_integration(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
    ...
    def test_get_pipeline_name_fallback_behavior(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
    ...
    def test_store_pipeline_metadata_handles_missing_step_instances(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
    ...
    def test_pipeline_name_generation_error_handling(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
    ...
    def test_generate_pipeline_complete_flow(
        self, temp_config_file, mock_registry_manager, mock_dependency_resolver
    ):
        ...
        with (
            ...
            mock_generate_name.assert_called_once()
            mock_assembler_class.assert_called_once()
            mock_assembler.generate_pipeline.assert_called_once_with(
