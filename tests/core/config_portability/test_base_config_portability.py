...
class TestBasePipelineConfigHybridResolution:
    ...
    def test_resolved_source_dir_property_exists(self, sample_config_data):
        ...
        config = BasePipelineConfig(source_dir="/some/test/path", **sample_config_data)
    ...
    def test_resolved_source_dir_with_none_source_dir(self, sample_config_data):
        ...
        config = BasePipelineConfig(source_dir=None, **sample_config_data)
    ...
    def test_effective_source_dir_property(self, sample_config_data):
        ...
        assert (
            effective == "/some/test/path"
            or effective is None
            or str(type(effective)) == "<class 'pydantic.fields.ModelPrivateAttr'>"
        )

        # Test with None source_dir
        config_none = BasePipelineConfig(source_dir=None, **sample_config_data)

        effective_none = config_none.effective_source_dir
        assert (
            effective_none is None
            or str(type(effective_none)) == "<class 'pydantic.fields.ModelPrivateAttr'>"
        )
    ...
    def test_hybrid_path_resolution_with_s3_paths(self, sample_config_data):
        ...
        config = BasePipelineConfig(source_dir=s3_path, **sample_config_data)
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                config = BasePipelineConfig(
                    source_dir="./dockers/xgboost_atoz", **sample_config_data
                )
    ...
    def test_model_dump_includes_resolved_paths(self, sample_config_data):
        ...
        assert (
            effective_dir_value == "/some/test/path"
    ...
    def test_hybrid_resolution_integration(
        ...
        config = BasePipelineConfig(source_dir=str(dockers_dir), **sample_config_data)
        ...
        assert (
            effective_source == str(dockers_dir)
            or str(type(effective_source))
            == "<class 'pydantic.fields.ModelPrivateAttr'>"
        )
...
class TestBasePipelineConfigEdgeCases:
    ...
    def test_empty_string_source_dir(self, sample_config_data):
        ...
        config = BasePipelineConfig(source_dir="", **sample_config_data)
    ...
    def test_windows_absolute_path(self, sample_config_data):
        ...
        config = BasePipelineConfig(source_dir=windows_path, **sample_config_data)
    ...
    def test_unicode_paths(self, sample_config_data):
        ...
        config = BasePipelineConfig(source_dir=unicode_path, **sample_config_data)
    ...
    def test_very_long_paths(self, sample_config_data):
        ...
        config = BasePipelineConfig(source_dir=long_path, **sample_config_data)
