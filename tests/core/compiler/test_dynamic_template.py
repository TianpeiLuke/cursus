...
class TestDynamicPipelineTemplate:
    ...
    def test_init_stores_config_path(self, mock_load_configs, mock_detect_classes):
    ...
    @patch("cursus.steps.configs.utils.detect_config_classes_from_json")
    @patch("cursus.steps.configs.utils.load_configs")
    def test_create_step_builder_map(self, mock_load_configs, mock_detect_classes):
    ...
    def test_validate_configuration_success(
        ...
        mock_validation_engine.validate_dag_compatibility.return_value = (
    ...
    def test_validate_configuration_failure(
        ...
        template._create_step_builder_map = MagicMock(
            side_effect=RegistryError("Step builder mapping failed")
        )
    ...
    def test_get_step_catalog_stats(
        ...
        self.mock_step_catalog.list_supported_step_types.return_value = [
            "Type1",
            "Type2",
            "Type3",
        ]
    ...
    def test_validate_before_build_failure(
        ...
        template._validate_configuration = MagicMock(
    ...
    def test_get_execution_order_failure(
        ...
        template._dag.topological_sort = MagicMock(
            side_effect=Exception("Topological sort failed")
        )
