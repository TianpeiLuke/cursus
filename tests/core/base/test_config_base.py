...
class TestBasePipelineConfig:
    ...
    def test_categorize_fields(self, valid_config_data):
        ...
        # Pydantic built-in properties may or may not be included depending on version
        # Check that at minimum our custom properties are present
        assert expected_derived.issubset(derived_fields)
