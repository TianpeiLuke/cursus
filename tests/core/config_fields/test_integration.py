...
class TestIntegration:
    ...
    def test_end_to_end_workflow(self):
        ...
        assert (
            loaded_configs["specific"][training_key]["hyperparameters"]["learning_rate"]
            == 0.05
        )
        ...
        assert loaded_configs["specific"][eval_key]["metrics"] == [
            "accuracy",
            "precision",
            "recall",
        ]
    ...
    def test_job_type_variants(self):
        ...
        assert found_training_in_name, (
            "Training job type variant not found in step names"
        )
        assert found_calibration_in_name, (
    ...
    def test_serialize_deserialize_with_nesting(self):
        ...
        if isinstance(deserialized, dict):
            ...
            assert deserialized["complex_dict"]["level1"]["level2"]["level3"] == [
                1,
                2,
                3,
            ]
