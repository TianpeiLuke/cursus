...
class SerializationTestConfig(BaseModel):
    ...
    def categorize_fields(self):
        ...
        return {"essential": ["field1"], "system": ["field2"], "derived": ["field3"]}
...
class TestTypeAwareConfigSerializer:
    ...
    def test_initialization_default(self):
        ...
        with patch(
            "cursus.core.config_fields.type_aware_config_serializer.get_unified_config_manager",
            create=True,
        ) as mock_get_manager:
            mock_manager = Mock()
    ...
    def test_initialization_with_parameters(self):
        ...
        serializer = TypeAwareConfigSerializer(config_classes=config_classes, mode=mode)
    ...
    def test_serialize_enum_with_type_preservation(self):
        ...
        assert (
            result["enum_class"]
            == f"{SerializationTestEnum.__module__}.{SerializationTestEnum.__name__}"
        )
    ...
    def test_serialize_pydantic_model_with_tier_awareness(self):
        ...
        test_config = SerializationTestConfig(
            field1="test_value", field2=42, field3=False
        )
    ...
    def test_serialize_pydantic_model_skip_none_system_fields(self):
        ...
        test_config = SerializationTestConfig(
            field1="test_value", field2=None, field3=True
        )
    ...
    def test_serialize_model_exception_handling(self):
        ...
        self.mock_unified_manager.get_field_tiers.side_effect = Exception(
            "Field tier error"
        )
    ...
    def test_serialize_dict_with_complex_values(self):
        ...
        test_dict = {"simple": "value", "complex": test_datetime}
...
class TestTypeAwareConfigSerializerDeserialization:
    ...
    def setup_and_teardown(self):
        ...
        self.mock_config_classes = {"SerializationTestConfig": SerializationTestConfig}
    ...
    def test_deserialize_primitives(self):
        ...
        test_cases = [None, "test_string", 42, 3.14, True, False]
    ...
    def test_deserialize_enum_missing_class_path(self):
        ...
        serialized_data = {"__type_info__": TYPE_MAPPING["Enum"], "value": "test_value"}
    ...
    def test_deserialize_unknown_type_info(self):
        ...
        serialized_data = {"__type_info__": "unknown_type", "value": "test_value"}
...
class TestSerializationConvenienceFunctions:
    ...
    def test_deserialize_config_function(self, mock_serializer_class):
        ...
        serialized_data = {"__model_type__": "TestConfig", "field1": "value1"}
        ...
        mock_serializer.deserialize.assert_called_once_with(
            serialized_data, expected_type=None
        )

    @patch(
        "cursus.core.config_fields.type_aware_config_serializer.TypeAwareConfigSerializer"
    )
    def test_deserialize_config_function_with_expected_type(
        ...
        result = deserialize_config(
            serialized_data, expected_type=SerializationTestConfig
        )
...
class TestSerializationIntegration:
    ...
    def test_round_trip_serialization_primitives(self):
        ...
        test_data = {
            ...
            "nested_dict": {"nested_string": "nested_value", "nested_int": 123},
        }
...
class TestErrorHandlingAndEdgeCases:
    ...
    def test_deserialize_with_field_name_tracking(self):
        ...
        test_data = {"level1": {"level2": ["item1", "item2", {"level3": "value"}]}}
    ...
    def test_logging_functionality(self):
        ...
        assert (
            self.serializer.logger.name
            == "cursus.core.config_fields.type_aware_config_serializer"
        )
