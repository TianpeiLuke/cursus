"""
Extended pytest tests for registry validation utilities.
...
class TestCreateValidationReport:
    ...
    def test_report_suggested_corrections(self):
        ...
        assert (
            corrections["builder_step_name"]["corrected"] == "MyCustomStepStepBuilder"
        )
    ...
    def test_report_with_different_validation_modes(self):
        ...
        step_data = {"config_class": "MyCustomStepConfiguration"}
...
class TestPerformanceMetrics:
    ...
    def test_performance_tracking_after_validation(self):
        ...
        step_data = {"name": "MyCustomStep", "config_class": "MyCustomStepConfig"}
    ...
    def test_performance_tracking_multiple_validations(self):
        ...
        if metrics["total_validations"] > 0 and metrics["total_time_ms"] > 0:
            ...
            assert (
                abs(metrics["average_time_ms"] - expected_avg) < 0.001
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_auto_correction_with_empty_values(self):
        ...
        step_data = {"name": "", "config_class": "", "builder_step_name": ""}
    ...
    def test_batch_validation_scenario(self):
        ...
        steps_to_validate = [
            ...
            (
                "invalid_step",
                {
                    "config_class": "InvalidConfig",
                    "builder_step_name": "InvalidBuilder",
                },
            ),
            (
                "AnotherValidStep",
                {
                    "config_class": "AnotherValidStepConfig",
                    "builder_step_name": "AnotherValidStepStepBuilder",
                },
            ),
            (
                "another_invalid",
                {"config_class": "WrongSuffix", "builder_step_name": "WrongSuffix"},
            ),
        ]
