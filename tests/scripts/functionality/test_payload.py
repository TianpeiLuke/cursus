...
class TestFieldDefaults:
    ...
    def test_get_field_defaults_from_json(self):
        ...
        environ_vars = {"FIELD_DEFAULTS": '{"field1": "value1", "field2": "value2"}'}
        defaults = get_field_defaults(environ_vars)
...
class TestFeatureColumnsIntegration:
    ...
    def test_get_required_fields_with_feature_columns(self, temp_dir):
        ...
        required = get_required_fields_from_model(temp_dir, hyperparams, var_type_list)
...
class TestMainIntegration:
    ...
    def _create_model_with_hyperparams(
        self, dirs, hyperparams, include_feature_columns=False
    ):
    ...
    def test_main_with_feature_columns(self, setup_dirs):
        ...
        self._create_model_with_hyperparams(
            dirs, hyperparams, include_feature_columns=True
        )
