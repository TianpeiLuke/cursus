...
class TestStreamlinedStepBuilderScorerAlignmentValidation:
    ...
    def test_score_alignment_validation_failed_status(self):
        ...
        alignment_data = {"results": {"overall_status": "FAILED"}}
...
class TestStreamlinedStepBuilderScorerStepCreation:
    ...
    def test_score_step_creation_completed_with_capability(self):
        ...
        step_creation_data = {"status": "COMPLETED", "capability_validated": True}
    ...
    def test_score_step_creation_completed_without_capability(self):
        ...
        step_creation_data = {"status": "COMPLETED", "capability_validated": False}
    ...
    def test_score_step_creation_unknown_status(self):
        ...
        step_creation_data = {"status": "UNKNOWN"}
...
class TestStreamlinedStepBuilderScorerOverallScoring:
    ...
    def test_calculate_overall_score_all_components(self):
        ...
        validation_results = {
            "components": {
                "alignment_validation": {"results": {"overall_status": "PASSED"}},
                "integration_testing": {
                    "status": "COMPLETED",
                    "checks": {"test": {"passed": True}},
                },
                "step_creation": {"status": "COMPLETED", "capability_validated": True},
            }
        }
    ...
    def test_calculate_overall_score_mixed_results(self):
        ...
        validation_results = {
            "components": {
                "alignment_validation": {"results": {"overall_status": "COMPLETED"}},
                "integration_testing": {"status": "ISSUES_FOUND"},
                "step_creation": {"status": "ERROR", "error": "Config error"},
            }
        }
...
class TestStreamlinedStepBuilderScorerReportGeneration:
    ...
    def test_generate_report_complete(self):
        ...
        assert (
            report["validation_results"]["validation_type"]
            == "comprehensive_builder_validation"
        )
    ...
    def test_generate_report_minimal_data(self):
        ...
        validation_results = {"step_name": "MinimalStep", "components": {}}
    ...
    def test_save_report(self):
        ...
        validation_results = {"step_name": "TestStep", "components": {}}
...
class TestStreamlinedStepBuilderScorerComponentScoring:
    ...
    def test_calculate_component_score_integration_testing(self):
        ...
        validation_results = {
            "components": {"integration_testing": {"status": "COMPLETED"}}
        }
...
class TestStreamlinedStepBuilderScorerUtilityFunctions:
    ...
    def test_score_builder_validation_results_no_save(self, capsys):
        ...
        report = score_builder_validation_results(
            validation_results, step_name="TestStep", save_report=False
        )
    ...
    def test_score_builder_results_legacy_compatibility(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Check that file was saved
            expected_file = (
                Path(temp_dir) / "LegacyBuilder_streamlined_score_report.json"
            )
            assert expected_file.exists()
...
class TestStreamlinedStepBuilderScorerErrorHandling:
    ...
    def test_score_alignment_validation_exception_handling(self):
        ...
        assert (
            score >= 85.0
        )  # PASSED status should get high score even with None result
        assert score <= 100.0
    ...
    def test_calculate_overall_score_with_missing_components(self):
        ...
        validation_results = {
            "components": {"unknown_component": {"status": "COMPLETED"}}
        }
            ...
            "results": {
                ...
                "validation_results": {
                    ...
                    "level_2": {
                        "result": {
                            "passed": False,
                            "issues": [{"severity": "ERROR", "message": "Error 2"}],
                        }
                    },
                },
            }
