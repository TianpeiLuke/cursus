...
from cursus.validation.alignment.validators.transform_step_validator import (
    TransformStepBuilderValidator,
)
...
class TestTransformStepBuilderValidator:
    ...
    def sample_transform_builder(self):
        ...
        class SampleTransformBuilder:
            ...
            def _create_transformer(self, model_name, output_path=None):
                return {
    ...
    def test_validate_builder_config_alignment_with_valid_transform_builder(
        self, validator, sample_transform_builder
    ):
    ...
    def test_apply_step_specific_validation_with_valid_builder(
        self, validator, sample_transform_builder
    ):
        """Test step-specific validation with valid Transform builder."""
        step_name = "BatchTransform"  # Use valid step name from registry
    ...
    def test_apply_step_specific_validation_missing_create_transformer(self, validator):
        ...
        with (
            ...
            assert any(
                "_create_transformer" in issue["message"] for issue in error_issues
            )

    def test_validate_create_transformer_method_with_valid_implementation(
        self, validator, sample_transform_builder
    ):
    ...
    def test_validate_create_transformer_method_missing_output_path_parameter(
        self, validator
    ):
    ...
    def test_validate_transform_outputs_with_valid_outputs(
        self, validator, sample_transform_builder
    ):
    ...
    def test_validate_transform_configuration_with_valid_configuration(
        self, validator, sample_transform_builder
    ):
    ...
    def test_validate_transformer_type_patterns_with_valid_patterns(
        self, validator, sample_transform_builder
    ):
