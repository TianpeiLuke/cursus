...
from cursus.validation.alignment.validators.processing_step_validator import (
...
class TestProcessingStepBuilderValidator:
    ...
    def test_validate_builder_config_alignment_with_valid_processing_builder(
        self, validator, sample_processing_builder
    ):
    ...
    def test_apply_step_specific_validation_missing_create_processor(self, validator):
        ...
        with (
            ...
            assert any(
                "_create_processor" in issue["message"] for issue in error_issues
            )
    ...
    def test_validate_create_processor_method_with_valid_implementation(
        self, validator, sample_processing_builder
    ):
    ...
    def test_validate_processing_outputs_with_valid_outputs(
        self, validator, sample_processing_builder
    ):
    ...
    def test_validate_job_arguments_override_with_valid_arguments(
        self, validator, sample_processing_builder
    ):
    ...
    def test_validate_processing_input_output_handling_with_valid_handling(
        self, validator, sample_processing_builder
    ):
