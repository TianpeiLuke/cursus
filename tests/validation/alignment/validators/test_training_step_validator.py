...
from cursus.validation.alignment.validators.training_step_validator import (
    TrainingStepBuilderValidator,
)
...
class TestTrainingStepBuilderValidator:
    ...
    def test_validate_builder_config_alignment_with_valid_training_builder(
        self, validator, sample_training_builder
    ):
    ...
    def test_apply_step_specific_validation_missing_create_estimator(self, validator):
        ...
        with (
            ...
            assert any(
                "_create_estimator" in issue["message"] for issue in error_issues
            )
    ...
    def test_validate_create_estimator_method_with_valid_implementation(
        self, validator, sample_training_builder
    ):
    ...
    def test_validate_create_estimator_method_missing_output_path_parameter(
        self, validator
    ):
    ...
    def test_validate_training_outputs_with_valid_outputs(
        self, validator, sample_training_builder
    ):
    ...
    def test_validate_training_configuration_with_valid_configuration(
        self, validator, sample_training_builder
    ):
    ...
    def test_validate_estimator_type_patterns_with_valid_patterns(
        self, validator, sample_training_builder
    ):
