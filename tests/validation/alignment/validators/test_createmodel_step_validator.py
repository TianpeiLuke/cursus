...
from cursus.validation.alignment.validators.createmodel_step_validator import (
    CreateModelStepBuilderValidator,
)
...
class TestCreateModelStepBuilderValidator:
    ...
    def test_validate_builder_config_alignment_with_valid_createmodel_builder(
        self, validator, sample_createmodel_builder
    ):
    ...
    def test_validate_create_model_method_with_valid_implementation(
        self, validator, sample_createmodel_builder
    ):
    ...
    def test_validate_createmodel_outputs_with_valid_outputs(
        self, validator, sample_createmodel_builder
    ):
    ...
    def test_validate_model_configuration_with_valid_config(
        self, validator, sample_createmodel_builder
    ):
    ...
    def test_validate_image_uri_method_without_get_image_uri_method(
        self, validator, sample_createmodel_builder
    ):
        ...
        class ComplexCreateModelBuilder:
            ...
            def _get_inputs(self):
                return {
                    f"model_data_{i}": {
                        "type": "ModelArtifacts",
                        "s3_uri": f"s3://bucket/model_{i}.tar.gz",
                    }
                    for i in range(5)
                }
            ...
            def _get_image_uri(self):
                return (
                    "683313688378.dkr.ecr.us-west-2.amazonaws.com/custom-image:latest"
                )
