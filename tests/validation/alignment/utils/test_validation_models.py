...
class TestValidationIssue:
    ...
    def test_validation_issue_to_dict(self):
        ...
        issue = ValidationIssue(
            level=IssueLevel.ERROR, message="Test message", details={"test": "data"}
        )
...
class TestValidationResult:
    ...
    def test_validation_result_creation(self):
        ...
        issues = [ValidationIssue(level=IssueLevel.ERROR, message="Test error")]
...
class TestValidationSummary:
    ...
    def test_validation_summary_success_rate(self):
        ...
        for i in range(10):
            ...
            result = ValidationResult(step_name=f"step{i}", status=status, issues=[])
            summary.add_result(result)
...
class TestUtilityFunctions:
    ...
    def test_create_validation_issue_helper(self):
        ...
        issue = ValidationIssue(level=IssueLevel.ERROR, message="Helper created issue")
    ...
    def test_validation_models_serialization(self):
        ...
        issue = ValidationIssue(level=IssueLevel.WARNING, message="Test serialization")
