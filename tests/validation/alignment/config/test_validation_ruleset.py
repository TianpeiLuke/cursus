...
class TestValidationRuleset:
    ...
    def test_is_validation_level_enabled(self):
        ...
        assert (
            is_validation_level_enabled("Processing", ValidationLevel.BUILDER_CONFIG)
            is True
        )
        ...
        assert (
            is_validation_level_enabled("CreateModel", ValidationLevel.BUILDER_CONFIG)
            is True
        )

        # Test excluded step types (should have no levels enabled)
        assert (
            is_validation_level_enabled("Base", ValidationLevel.SCRIPT_CONTRACT)
            is False
        )
        assert (
            is_validation_level_enabled("Base", ValidationLevel.SPEC_DEPENDENCY)
            is False
        )
        ...
        assert (
            is_validation_level_enabled(
                "InvalidStepType", ValidationLevel.SCRIPT_CONTRACT
            )
            is False
        )
    ...
    def test_registry_integration_functions(self):
        ...
        enabled = is_validation_level_enabled_for_step_name(
            "test_processing_step", ValidationLevel.SPEC_DEPENDENCY
        )
    ...
    def test_api_function_error_handling(self):
        ...
        assert (
            is_validation_level_enabled(None, ValidationLevel.SCRIPT_CONTRACT) is False
        )
