...
from cursus.validation.alignment.core_models import AlignmentLevel
...
class TestAlignmentLevel:
    ...
    def test_alignment_level_comparison(self):
        ...
        assert (
            AlignmentLevel.SCRIPT_CONTRACT.value
            < AlignmentLevel.CONTRACT_SPECIFICATION.value
        )
    ...
    def test_alignment_level_string_representation(self):
        ...
        assert (
            str(AlignmentLevel.CONTRACT_SPECIFICATION)
            == "AlignmentLevel.CONTRACT_SPECIFICATION"
        )
        assert (
            str(AlignmentLevel.SPECIFICATION_DEPENDENCY)
            == "AlignmentLevel.SPECIFICATION_DEPENDENCY"
        )
        assert (
            str(AlignmentLevel.BUILDER_CONFIGURATION)
            == "AlignmentLevel.BUILDER_CONFIGURATION"
        )
