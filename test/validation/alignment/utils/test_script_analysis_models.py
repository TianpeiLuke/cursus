...
class TestPathReference:
    ...
    def test_path_reference_creation(self):
        ...
        path_ref = PathReference(
            path="/opt/ml/input/data/train", line_number=10, context="data loading"
        )
    ...
    def test_path_reference_defaults(self):
        ...
        path_ref = PathReference(
            path="/opt/ml/model", line_number=1, context="model loading"
        )
    ...
    def test_path_reference_serialization(self):
        ...
        path_ref = PathReference(
            path="/opt/ml/processing/output", line_number=25, context="output saving"
        )
...
class TestImportStatement:
    ...
    def test_import_statement_creation(self):
        ...
        import_stmt = ImportStatement(
            module_name="xgboost", import_alias="xgb", line_number=1
        )
    ...
    def test_import_statement_no_alias(self):
        ...
        import_stmt = ImportStatement(
            module_name="pandas", import_alias=None, line_number=2
        )
    ...
    def test_import_statement_defaults(self):
        ...
        import_stmt = ImportStatement(
            module_name="torch", import_alias=None, line_number=1
        )
    ...
    def test_import_statement_serialization(self):
        ...
        import_stmt = ImportStatement(
            module_name="sklearn.ensemble", import_alias=None, line_number=5
        )
...
class TestArgumentDefinition:
    ...
    def test_argument_definition_no_default(self):
        ...
        arg_def = ArgumentDefinition(
            argument_name="model_name", line_number=12, argument_type="str"
        )
    ...
    def test_argument_definition_defaults(self):
        ...
        arg_def = ArgumentDefinition(argument_name="learning_rate", line_number=5)
...
class TestScriptAnalysisModelsIntegration:
    ...
    def test_models_work_together(self):
        ...
        path_ref = PathReference(
            path="/opt/ml/input/data", line_number=5, context="data loading"
        )
        env_var = EnvVarAccess(
            variable_name="SM_CHANNEL_TRAIN",
            line_number=6,
        ...
        import_stmt = ImportStatement(
            module_name="pandas", import_alias="pd", line_number=1
        )
        arg_def = ArgumentDefinition(
            argument_name="data_path", line_number=10, argument_type="str"
        )
        path_const = PathConstruction(
            base_path="base",
            construction_parts=["file"],
            line_number=15,
            context="path construction",
            method="os.path.join",
        )
