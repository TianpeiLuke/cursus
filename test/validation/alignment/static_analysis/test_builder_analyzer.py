...
"""
    ...
    def test_extract_builder_arguments_script_not_found(self):
        ...
        arguments = extract_builder_arguments(
            "nonexistent_script", str(self.builders_dir)
        )
    ...
    @patch(
        "cursus.validation.alignment.static_analysis.builder_analyzer.BuilderArgumentExtractor"
    )
