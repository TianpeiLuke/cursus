...
'''
        ...
        issues = self.validator.validate_script_testability("no_main_script.py", ast_tree)
...
'''
        ...
        issues = self.validator.validate_script_testability("partial_script.py", ast_tree)
...
'''
        ...
        issues = self.validator.validate_script_testability("helper_env_script.py", ast_tree)
...
'''
        ...
        issues = self.validator.validate_script_testability("container_script.py", ast_tree)
...
'''
        ...
        issues = self.validator.validate_script_testability("no_call_script.py", ast_tree)
...
'''
        ...
        issues = self.validator.validate_script_testability("comprehensive_script.py", ast_tree)
