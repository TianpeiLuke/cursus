...
class TestLevelValidation:
    ...
    def test_level1_validation_with_mock_results(self, tester):
        ...
        with patch.object(tester.level1_tester, 'validate_all_scripts') as mock_validate:
    ...
    def test_validate_specific_script(self, tester):
        ...
        with patch.object(tester.level1_tester, 'validate_script') as mock_l1, \
             patch.object(tester.level2_tester, 'validate_contract') as mock_l2, \
             patch.object(tester.level3_tester, 'validate_specification') as mock_l3, \
             patch.object(tester.level4_tester, 'validate_builder') as mock_l4:
