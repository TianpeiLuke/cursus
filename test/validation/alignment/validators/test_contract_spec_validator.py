...
class TestContractSpecValidator:
    ...
    def test_validate_logical_names_perfect_match(self):
    ...
    def test_validate_logical_names_missing_contract_input(self):
        ...
        contract_missing_input = self.sample_contract.copy()
    ...
    def test_validate_logical_names_extra_contract_input(self):
        ...
        contract_extra_input = self.sample_contract.copy()
    ...
    def test_validate_logical_names_missing_contract_output(self):
        ...
        contract_missing_output = self.sample_contract.copy()
    ...
    def test_validate_logical_names_extra_contract_output(self):
        ...
        contract_extra_output = self.sample_contract.copy()
    ...
    def test_validate_data_types_basic(self):
        ...
        issues = self.validator.validate_data_types(
            self.sample_contract,
            self.sample_specification,
            "model_training"
        )
    ...
    def test_validate_input_output_alignment_perfect_match(self):
        ...
        issues = self.validator.validate_input_output_alignment(
            self.sample_contract,
            self.sample_specification,
            "model_training"
        )
    ...
    def test_validate_input_output_alignment_unmatched_dependency(self):
        ...
        spec_extra_dep = self.sample_specification.copy()
        spec_extra_dep['dependencies'] = self.sample_specification['dependencies'] + [
            {
    ...
    def test_validate_input_output_alignment_unmatched_output(self):
        ...
        spec_extra_output = self.sample_specification.copy()
        spec_extra_output['outputs'] = self.sample_specification['outputs'] + [
            {
...
class TestContractSpecValidatorEdgeCases:
    ...
    def test_validate_with_malformed_contract(self):
    ...
    def test_issue_format_consistency(self):
        ...
        logical_issues = self.validator.validate_logical_names(contract, spec, "test")
        data_type_issues = self.validator.validate_data_types(contract, spec, "test")
        alignment_issues = self.validator.validate_input_output_alignment(contract, spec, "test")
