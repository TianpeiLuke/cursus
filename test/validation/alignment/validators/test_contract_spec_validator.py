...
class TestContractSpecValidator:
    ...
    def test_validate_logical_names_perfect_match(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_logical_names_missing_contract_input(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_logical_names_extra_contract_input(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_logical_names_missing_contract_output(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_logical_names_extra_contract_output(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_logical_names_empty_contract(self, validator, sample_specification):
    ...
    def test_validate_logical_names_empty_specification(self, validator, sample_contract):
    ...
    def test_validate_logical_names_with_job_type(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_logical_names_missing_logical_name_in_spec(self, validator, sample_contract):
    ...
    def test_validate_data_types_basic(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_input_output_alignment_perfect_match(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_input_output_alignment_unmatched_dependency(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_input_output_alignment_unmatched_output(self, validator, sample_contract, sample_specification):
    ...
    def test_validate_input_output_alignment_none_logical_names(self, validator, sample_contract):
    ...
    def test_validate_input_output_alignment_empty_spec(self, validator, sample_contract):
    ...
    def test_validate_input_output_alignment_empty_contract(self, validator, sample_specification):
    ...
    def test_validate_input_output_alignment_missing_keys(self, validator, sample_specification):
...
class TestContractSpecValidatorEdgeCases:
    ...
    def test_validate_with_malformed_contract(self, validator):
        ...
        issues = validator.validate_input_output_alignment(malformed_contract, spec, "test")
        assert isinstance(issues, list)
    ...
    def test_validate_with_malformed_specification(self, validator):
        ...
        issues = validator.validate_input_output_alignment(contract, malformed_spec, "test")
        assert isinstance(issues, list)
    ...
    def test_validate_with_complex_logical_names(self, validator):
        ...
        contract = {
            ...
            'outputs': {
                'output-complex-name': {'path': '/output1'}
            }
        }
        ...
        spec = {
            ...
            'dependencies': [
                ...
                {'logical_name': 'input_with_underscores', 'dependency_type': 'InputData'},
                {'logical_name': 'input.with.dots', 'dependency_type': 'InputData'}
            ],
            'outputs': [
                {'logical_name': 'output-complex-name', 'output_type': 'Data'}
            ]
        }
    ...
    def test_issue_format_consistency(self, validator):
        ...
        spec = {
            'step_type': 'TestStep',
            'node_type': 'ProcessingJob',
            'dependencies': [{'logical_name': 'spec_dep', 'dependency_type': 'InputData'}],
        ...
        alignment_issues = validator.validate_input_output_alignment(contract, spec, "test")
