...
class TestInterfaceStandardValidator:
    ...
    def test_validate_step_builder_interface_good_builder(self, validator):
        ...
        inheritance_violations = [
            v for v in violations if v.violation_type.startswith("inheritance")
        ]
        method_violations = [
            v for v in violations if v.violation_type.startswith("method")
        ]
        ...
        critical_violations = [
            ...
            for v in violations
            if v.violation_type
            in ["inheritance_missing", "method_missing", "method_not_callable"]
        ]
    ...
    def test_validate_required_methods_bad_builder(self, validator):
        ...
        missing_methods = [
            v for v in violations if v.violation_type == "method_missing"
        ]
    ...
    def test_validate_method_signatures_good_builder(self, validator):
        ...
        critical_signature_violations = [
            v
            for v in violations
            if v.violation_type
            in ["signature_missing_param", "signature_missing_kwargs"]
        ]
    ...
    def test_validate_method_signatures_bad_builder(self, validator):
        ...
        signature_violations = [
            v for v in violations if v.violation_type.startswith("signature")
        ]
    ...
    def test_validate_method_documentation_good_builder(self, validator):
        ...
        missing_doc_violations = [
            v for v in violations if v.violation_type == "documentation_missing"
        ]
    ...
    def test_validate_method_documentation_undocumented_builder(self, validator):
        ...
        violations = validator.validate_method_documentation(
            MockUndocumentedStepBuilder
        )
    ...
    def test_validate_class_documentation_good_builder(self, validator):
        ...
        missing_class_doc_violations = [
            v for v in violations if v.violation_type == "class_documentation_missing"
        ]
    ...
    def test_validate_builder_registry_compliance_good_name(self, validator):
        ...
        naming_violations = [
            v for v in violations if v.violation_type == "registry_naming_convention"
        ]
