...
@pytest.mark.skipif(not ENHANCED_MODELS_AVAILABLE, reason="Enhanced models not available")
class TestEnhancedScriptExecutionSpec:
    ...
    def test_enhanced_script_execution_spec_creation(self):
        ...
        assert spec.input_path_specs["training_data"].aliases == ["processed_data", "clean_data"]
    ...
    def test_enhanced_spec_from_script_execution_spec(self):
        ...
        assert enhanced_spec.output_path_specs["data_output"].aliases == ["processed_data"]
...
class TestModelIntegration:
    ...
    def test_pipeline_testing_spec_with_multiple_scripts(self):
        ...
        pipeline_spec = PipelineTestingSpec(
            ...
            test_workspace_root="test/integration"
        )
...
class TestModelEdgeCases:
    ...
    def test_pipeline_testing_spec_single_node(self):
        ...
        pipeline_spec = PipelineTestingSpec(
            dag=dag,
            script_specs={"single_script": spec}
        )
    ...
    def test_special_characters_in_paths(self):
        ...
        spec = ScriptExecutionSpec(
            ...
            output_paths={
                "output_special": "/output/with-dashes_and.dots/result.json"
            }
        )
        ...
        assert spec.output_paths["output_special"] == "/output/with-dashes_and.dots/result.json"
