...
from cursus.validation.runtime.workspace_aware_spec_builder import WorkspaceAwarePipelineTestingSpecBuilder
...
class TestWorkspaceAwarePipelineTestingSpecBuilder:
    ...
    def test_canonical_to_script_name_conversion(self):
        ...
        for canonical, expected in test_cases:
            ...
            assert result == expected, f"Expected {expected}, got {result} for {canonical}"
