...
class TestConfigInheritance(unittest.TestCase):
    ...
    def test_config_inheritance(self):
        ...
        self.assertEqual(
            processing_config.pipeline_version, base_config.pipeline_version
        )
        ...
        self.assertEqual(
            processing_config.pipeline_name,
            f"{base_config.author}-{base_config.service_name}-{base_config.model_class}-{base_config.region}",
        )

        # Test that child-specific derived fields are initialized
        self.assertEqual(
            processing_config.effective_instance_type,
            processing_config.processing_instance_type_large,
        )
    ...
    def test_field_override(self):
        ...
        self.assertEqual(
            processing_config.aws_region, "us-west-2"
        )  # FE region maps to us-west-2
