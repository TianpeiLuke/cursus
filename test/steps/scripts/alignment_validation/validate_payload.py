#!/usr/bin/env python3
"""
Individual Alignment Validation Script for payload

This script validates the alignment between script, contract, specification,
and builder configuration for the payload script.
"""
...
def main():
    """Run alignment validation for payload script."""
    print("🔍 Payload Script Alignment Validation")
    print("=" * 60)
    ...
    # Run validation for payload script
    script_name = "payload"
...
<html>
<head>
    <title>Alignment Validation Report - payload</title>
    <style>
