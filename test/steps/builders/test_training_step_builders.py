...
class TrainingStepBuilderTestSuite:
    ...
    EXPECTED_ESTIMATORS = {"PyTorchTraining": "PyTorch", "XGBoostTraining": "XGBoost"}

    # Framework versions expected
    EXPECTED_FRAMEWORKS = {"PyTorchTraining": "pytorch", "XGBoostTraining": "xgboost"}
    ...
    def run_training_specific_tests(
        ...
        results["test_estimator_creation_method"] = (
            self._test_estimator_creation_method(step_name, builder_class)
        )
        ...
        results["test_training_environment_variables"] = (
            self._test_training_environment_variables(step_name, builder_class)
        )
    ...
    def _test_estimator_creation_method(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
    ...
    def _test_expected_estimator_type(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if not expected_estimator:
                return {
                    ...
                    "error": None,
                    "details": {
                        "note": f"No expected estimator defined for {step_name}"
                    },
                }
    ...
    def _test_training_environment_variables(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
    ...
    def _test_hyperparameters_handling(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
        """Test that the builder handles hyperparameters correctly."""
        try:
            # Check if the builder has hyperparameters handling
            has_hyperparams_method = hasattr(
                builder_class, "_upload_hyperparameters_to_s3"
            )
    ...
    def _test_training_step_creation(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
