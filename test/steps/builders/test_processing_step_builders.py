...
class ProcessingStepBuilderTestSuite:
    ...
    def run_processing_specific_tests(
        ...
        results["test_processor_creation_method"] = (
            self._test_processor_creation_method(step_name, builder_class)
        )
        ...
        results["test_processing_environment_variables"] = (
            self._test_processing_environment_variables(step_name, builder_class)
        )
    ...
    def _test_processor_creation_method(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
    ...
    def _test_expected_processor_type(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if not expected_processor:
                return {
                    ...
                    "error": None,
                    "details": {
                        "note": f"No expected processor defined for {step_name}"
                    },
                }
            ...
            processor_method = (
                "_create_processor" if has_create_processor else "_get_processor"
            )
            return {
                "passed": True,
                "error": None,
    ...
    def _test_processing_io_methods(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
    ...
    def _test_processing_environment_variables(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
    ...
    def _test_job_arguments_handling(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
    ...
    def _test_processing_step_creation(
        self, step_name: str, builder_class: Type[StepBuilderBase]
    ) -> Dict[str, Any]:
