...
class TestDependencyEdge(unittest.TestCase):
    ...
    def test_create_dependency_edge_with_custom_values(self):
        ...
        self.assertEqual(
            edge.edge_type, "sequential"
        )  # Pydantic stores enum values as strings
...
class TestConditionalEdge(unittest.TestCase):
    ...
    @patch("cursus.api.dag.edge_types.logger")
...
class TestEdgeCollection(unittest.TestCase):
    ...
    def test_add_duplicate_edge_higher_confidence(self):
        ...
        with patch("cursus.api.dag.edge_types.logger") as mock_logger:
    ...
    def test_add_duplicate_edge_lower_confidence(self):
        ...
        with patch("cursus.api.dag.edge_types.logger") as mock_logger:
            edge_id = self.collection.add_edge(
                self.edge1
            )  # confidence=1.0 should replace 0.9
    ...
    def test_get_statistics(self):
        ...
        )  # parallel edge has 0.6 confidence, but default threshold is 0.6
        ...
        expected_edge_types = {"dependency": 1, "conditional": 1, "parallel": 1}
