...
class TestWorkspaceUnifiedAlignmentTester:
    ...
    @patch('cursus.workspace.validation.workspace_alignment_tester.UnifiedAlignmentTester.run_full_validation')
    def test_run_workspace_validation_single_developer(self, mock_run_validation, tester):
    ...
    @patch('cursus.workspace.validation.workspace_alignment_tester.UnifiedAlignmentTester.__init__')
