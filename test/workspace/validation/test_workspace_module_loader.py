...
'''
        (cursus_dev_dir / "builders" / "test_step_builder.py").write_text(
            builder_content
        )
...
'''
        (cursus_dev_dir / "contracts" / "test_step_contract.py").write_text(
            contract_content
        )
...
'''
        (shared_cursus_dev_dir / "builders" / "shared_builder.py").write_text(
            shared_builder_content
        )
    ...
    def test_load_module_from_file_success(
        self, mock_module_from_spec, mock_spec_from_file, temp_workspace
    ):
