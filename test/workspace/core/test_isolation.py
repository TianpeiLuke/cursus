...
from cursus.workspace.core.isolation import (
...
class TestWorkspaceIsolationManager(unittest.TestCase):
    ...
    def test_validate_workspace_boundaries_workspace_not_found(self):
        ...
        result = isolation_manager.validate_workspace_boundaries(
    ...
    def test_detect_isolation_violations_workspace_not_found(self):
        ...
        violations = isolation_manager.detect_isolation_violations(
            "nonexistent_workspace"
        )
    ...
    def test_manage_namespace_isolation(self):
        ...
        namespaced_name = isolation_manager.manage_namespace_isolation(
            "developer_1", "test_component"
        )
        self.assertEqual(namespaced_name, "developer_1:test_component")

        # Test shared workspace
        shared_name = isolation_manager.manage_namespace_isolation(
    ...
    def test_get_statistics(self):
        ...
        with patch.object(
            isolation_manager, "get_workspace_health", return_value={"healthy": True}
        ):
...
"""
        ...
        workspace_path = self.temp_workspace / "developer_1"
        problematic = isolation_manager._detect_problematic_imports(
            code_with_problems, workspace_path
        )
...
"""
    ...
    def test_contains_absolute_paths_outside_workspace(self):
        ...
        config_content = (
            '{"path": "/tmp/outside_workspace", "internal": "relative/path"}'
        )
        config_file.write_text(config_content)

        # This should return False since /tmp doesn't exist in our test
        result = isolation_manager._contains_absolute_paths_outside_workspace(
            config_file, self.temp_workspace
        )
        self.assertFalse(result)
