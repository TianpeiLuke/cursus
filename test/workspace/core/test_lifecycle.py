...
class TestWorkspaceLifecycleManager(unittest.TestCase):
    ...
    def test_create_workspace_success(self):
        ...
        with patch("pathlib.Path.mkdir") as mock_mkdir, patch(
            "pathlib.Path.touch"
        ) as mock_touch, patch("pathlib.Path.exists", return_value=False):
    ...
    def test_apply_template(self):
        ...
        with patch.object(
            lifecycle_manager, "_create_structure_from_metadata"
        ) as mock_create:
    ...
    def test_delete_workspace(self):
        ...
        with patch("shutil.rmtree") as mock_rmtree, patch.object(
            lifecycle_manager, "_workspace_has_data", return_value=True
        ), patch.object(
            lifecycle_manager, "_archive_workspace_data", return_value=Path("/archive")
        ):
    ...
    def test_restore_workspace(self):
        ...
        with patch("builtins.open", MagicMock()) as mock_open, patch(
            ...
            result = lifecycle_manager.restore_workspace(
                "developer_1", str(archive_path)
            )
    ...
    def test_cleanup_inactive_workspaces(self):
        ...
        with patch.object(
            lifecycle_manager, "_workspace_has_data", return_value=False
    ...
    def test_create_structure_from_metadata(self):
        ...
        metadata = {
            "structure": {"src": {"test_file.py": "# Test content"}, "config": {}}
        }
