...
class TestWorkspaceComponentRegistry(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_workspace_manager.discover_workspaces.return_value = (
            mock_workspace_info
        )
    ...
    def test_registry_initialization_with_discovery_manager(self, mock_discovery_class):
        ...
        registry = WorkspaceComponentRegistry(
            workspace_root=self.temp_workspace, discovery_manager=mock_discovery
        )
    ...
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_registry_initialization_without_discovery_manager(
        self, mock_discovery_class, mock_manager_class
    ):
    ...
    @patch("cursus.workspace.core.manager.WorkspaceManager")
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_discover_components_all_developers(
        self, mock_discovery_class, mock_manager_class
    ):
        ...
        registry = WorkspaceComponentRegistry(
            self.temp_workspace, discovery_manager=mock_discovery
        )
    ...
    @patch("cursus.workspace.core.manager.WorkspaceManager")
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_discover_components_specific_developer(
        self, mock_discovery_class, mock_manager_class
    ):
    ...
    @patch("cursus.workspace.core.manager.WorkspaceManager")
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_discover_components_caching(
        self, mock_discovery_class, mock_manager_class
    ):
    ...
    @patch("cursus.workspace.core.manager.WorkspaceManager")
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_find_builder_class_specific_developer(
        self, mock_discovery_class, mock_manager_class
    ):
    ...
    @patch("cursus.workspace.core.manager.WorkspaceManager")
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_find_builder_class_any_developer(
        self, mock_discovery_class, mock_manager_class
    ):
    ...
    def test_find_builder_class_core_fallback(
        self, mock_step_names, mock_discovery_class, mock_manager_class
    ):
        ...
        registry.core_registry.get_builder_for_step_type = Mock(
            return_value=mock_core_builder
        )
    ...
    def test_get_workspace_summary(self, mock_discovery_class, mock_manager_class):
        ...
        with patch.object(
            registry, "discover_components", return_value=mock_components
        ):
    ...
    @patch("cursus.workspace.core.manager.WorkspaceManager")
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_validate_component_availability_valid(
        self, mock_discovery_class, mock_manager_class
    ):
        ...
        with patch.object(
            registry, "find_builder_class", return_value=mock_builder
    ...
    @patch("cursus.workspace.core.manager.WorkspaceManager")
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_validate_component_availability_missing(
        self, mock_discovery_class, mock_manager_class
    ):
        ...
        with patch.object(
            registry, "find_builder_class", return_value=None
            ...
            self.assertEqual(
                result["missing_components"][0]["step_name"], "missing_step"
            )
            self.assertEqual(
                result["missing_components"][0]["component_type"], "builder"
            )
    ...
    @patch("cursus.workspace.core.manager.WorkspaceManager")
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_discover_developer_components_error_handling(
        self, mock_discovery_class, mock_manager_class
    ):
        """Test error handling in developer component discovery."""
        mock_discovery = Mock()
        mock_discovery.get_component_cache.return_value = {}
        mock_discovery.discover_workspace_components.side_effect = Exception(
            "Test error"
        )
        mock_discovery_class.return_value = mock_discovery
    ...
    @patch("cursus.workspace.core.manager.WorkspaceManager")
    @patch("cursus.workspace.core.discovery.WorkspaceDiscoveryManager")
    def test_optimized_component_discovery_with_caching(
        self, mock_discovery_class, mock_manager_class
    ):
