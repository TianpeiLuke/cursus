...
class TestWorkspaceIntegrationManager(unittest.TestCase):
    ...
    def test_integration_manager_initialization(self):
        ...
        self.assertIs(
            integration_manager.workspace_manager, self.mock_workspace_manager
        )
    ...
    def test_stage_for_integration_success(self):
        ...
        self.mock_workspace_manager.discovery_manager._check_component_exists.return_value = (
            True
        )

        result = integration_manager.stage_for_integration(
            "test_component", "developer_1"
        )
    ...
    def test_stage_for_integration_component_not_found(self):
        ...
        result = integration_manager.stage_for_integration(
            "non_existent_component", "developer_1"
        )
    ...
    def test_validate_integration_readiness_ready(self):
        ...
        result = integration_manager.validate_integration_readiness(
            ["developer_1:comp1", "developer_2:comp2"]
        )
    ...
    def test_validate_integration_readiness_not_ready(self):
        ...
        result = integration_manager.validate_integration_readiness(
            ["nonexistent:comp1", "missing:comp2"]
        )
    ...
    def test_rollback_integration_success(self):
        ...
        with patch.object(
            integration_manager, "_remove_from_production"
        ) as mock_remove:
    ...
    def test_determine_component_type(self):
        ...
        component_type = integration_manager._determine_component_type(
            "test_builder", "developer_1"
        )
        self.assertEqual(component_type, "builders")

        # Test non-existent component
        component_type = integration_manager._determine_component_type(
            "nonexistent", "developer_1"
        )
