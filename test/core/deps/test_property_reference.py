...
class TestPropertyReference:
    ...
    def test_get_property_value(self):
        ...
        test_obj.ProcessingOutputConfig.Outputs["processed_data"].S3Output.S3Uri = (
    ...
    def _create_mock_transform_step(self):
        ...
        mock_step.properties.TransformOutput.Outputs[0].S3OutputPath = (
            "s3://test-bucket/predictions"
        )
