...
class TestTypeAwareSerialization(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.nested_config = TestConfig(
            name="nested_test", nested=NestedModel(value="custom", numbers=[4, 5, 6])
        )
        ...
        self.calibration_config = JobTypeConfig(
            name="calib_test", job_type="calibration"
        )
        ...
        self.complex_variant_config = JobTypeConfig(
            name="complex", job_type="training", data_type="tabular", mode="incremental"
        )
