...
class CircularReferenceTrackerTest(unittest.TestCase):
    ...
    def test_complex_nested_paths(self):
        ...
        level2b["child"] = (
            level3  # Both level2a and level2b point to same level3 (diamond pattern)
        )
    ...
    def test_error_message_formatting(self):
        ...
        grandchild = {
            "__model_type__": "GrandchildConfig",
            "name": "grandchild",
            "id": 4,
        }
    ...
    def _format_cycle_error_manual(
        self, obj_data: Any, field_name: str, obj_id: Any
    ) -> str:
