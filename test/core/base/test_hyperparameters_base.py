...
class TestModelHyperparameters:
    ...
    def test_init_with_all_fields(self, valid_hyperparam_data):
        ...
        assert hyperparam.full_field_list == ["id", "feature1", "feature2", "category1", "label"]
    ...
    def test_from_base_hyperparam(self, valid_hyperparam_data):
        ...
        assert derived_hyperparam.multiclass_categories == base_hyperparam.multiclass_categories
    ...
    def test_serialize_config(self, valid_hyperparam_data):
        ...
        assert json.loads(serialized['multiclass_categories']) == hyperparam.multiclass_categories
