...
class TestOutputSpec:
    ...
    def test_init_with_required_fields(self):
        ...
        assert output_spec.property_path == "properties.TestStep.Properties.OutputDataConfig.S3OutputPath"
...
class TestStepSpecification:
    ...
    def test_get_dependency(self, output_spec, dependency_spec):
        ...
        spec_data = {
            "step_type": "TestStep",
            "node_type": NodeType.INTERNAL,
            "dependencies": {"test_dependency": dependency_spec},  # Key matches logical name
    ...
    def test_validate_contract_alignment_no_contract(self, spec_data):
        ...
        assert "No contract to validate" in (result.errors[0] if result.errors else "No contract to validate")
