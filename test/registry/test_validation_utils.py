    ...
    def test_invalid_step_name_format(self):
        ...
        test_cases = [
            ...
            (
                "123CustomStep",
                "CustomStep",
            ),  # starts with number - should remove leading digits
...
class TestGetValidationErrorsWithSuggestions:
    ...
    def test_builder_name_examples(self):
        ...
        step_data = {"name": "MyCustomStep", "builder_step_name": "MyCustomBuilder"}
...
class TestValidationPatterns:
    ...
    def test_pascal_case_pattern(self):
        ...
        for name in valid_names:
            assert PASCAL_CASE_PATTERN.match(
                name
            ), f"'{name}' should be valid PascalCase"

        for name in invalid_names:
            assert not PASCAL_CASE_PATTERN.match(
                name
            ), f"'{name}' should be invalid PascalCase"
