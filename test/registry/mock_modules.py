...
cradle_mock.cradle_data_loading.cradle_data_loading_step.CradleDataLoadingStep = (
    MagicMock()
)
...
sys.modules["secure_ai_sandbox_workflow_python_sdk.cradle_data_loading"] = (
    cradle_mock.cradle_data_loading
)
sys.modules[
    "secure_ai_sandbox_workflow_python_sdk.cradle_data_loading.cradle_data_loading_step"
] = cradle_mock.cradle_data_loading.cradle_data_loading_step
sys.modules["secure_ai_sandbox_workflow_python_sdk.utils"] = cradle_mock.utils
sys.modules["secure_ai_sandbox_workflow_python_sdk.utils.constants"] = (
    cradle_mock.utils.constants
)
