...
class TestDAGMetadataRegistrySync:
    ...
    def test_init_with_existing_registry(self, temp_registry_path, sample_registry_data):
    ...
    def test_validate_registry_structure_missing_metadata_field(self, sample_registry_data):
        """Test validating registry with missing metadata field."""
        del sample_registry_data["metadata"]["total_pipelines"]
        
        sync = DAGMetadataRegistrySync()
        
        with pytest.raises(RegistryValidationError, match="Missing required metadata field"):
            sync._validate_registry_structure(sample_registry_data)
    ...
    def test_validate_node_structure_missing_atomic_property(self, sample_registry_data):
    ...
    def test_sync_metadata_to_registry_new_pipeline(self, temp_registry_path, sample_enhanced_metadata):
    ...
    def test_sync_metadata_to_registry_update_existing(self, temp_registry_path, sample_registry_data, sample_enhanced_metadata):
    ...
    def test_sync_registry_to_metadata_success(self, temp_registry_path, sample_registry_data):
    ...
    def test_sync_registry_to_metadata_not_found(self, temp_registry_path, sample_registry_data):
    ...
    def test_extract_zettelkasten_metadata_from_node(self, sample_registry_data):
        ...
        node["connections"] = {
            "alternatives": [{"id": "alt_pipeline", "annotation": "Alternative approach"}],
    ...
    def test_validate_consistency_success(self, temp_registry_path, sample_registry_data, sample_enhanced_metadata):
        ...
        sample_enhanced_metadata.zettelkasten_metadata.atomic_id = "xgb_simple_training"
        sample_enhanced_metadata.zettelkasten_metadata.single_responsibility = "Train XGBoost model"
        
        errors = sync.validate_consistency(sample_enhanced_metadata, "xgb_simple_training")
        assert len(errors) == 0
    
    def test_validate_consistency_mismatches(self, temp_registry_path, sample_registry_data, sample_enhanced_metadata):
    ...
    def test_validate_consistency_pipeline_not_found(self, temp_registry_path, sample_enhanced_metadata):
        """Test consistency validation for non-existent pipeline."""
        sync = DAGMetadataRegistrySync(temp_registry_path)
        
        errors = sync.validate_consistency(sample_enhanced_metadata, "non_existent_pipeline")
    ...
    def test_update_registry_metadata(self, sample_registry_data):
        ...
        sample_registry_data["nodes"]["pytorch_training"] = {
            ...
            "connections": {
                "alternatives": [{"id": "xgb_simple_training", "annotation": "XGBoost alternative"}]
            }
        }
    ...
    def test_remove_pipeline_from_registry_success(self, temp_registry_path, sample_registry_data):
    ...
    def test_remove_pipeline_from_registry_not_found(self, temp_registry_path, sample_registry_data):
    ...
    def test_remove_from_tag_index(self, sample_registry_data):
        ...
        tag_index = sample_registry_data["tag_index"]
        tag_index["framework_tags"]["pytorch"] = ["xgb_simple_training", "other_pipeline"]
        ...
        assert "other_pipeline" in tag_index["framework_tags"]["pytorch"]  # Other pipeline should remain
