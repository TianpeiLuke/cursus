...
class TestEnhancedDAGMetadata:
    ...
    def test_enhanced_dag_metadata_with_custom_zettelkasten(self, sample_zettelkasten_metadata):
    ...
    def test_to_registry_node(self, sample_enhanced_metadata):
        ...
        assert atomic_props["single_responsibility"] == "XGBoost training pipeline for tabular data"
...
class TestValidateEnhancedDAGMetadata:
    ...
    def test_validate_enhanced_dag_metadata_invalid_connection_type(self, valid_enhanced_metadata):
        """Test validation with invalid connection type."""
        # Add invalid connection type
        valid_enhanced_metadata.zettelkasten_metadata.manual_connections["invalid_type"] = ["target"]
        
        with pytest.raises(ValueError, match="Invalid connection type"):
            validate_enhanced_dag_metadata(valid_enhanced_metadata)
    
    def test_validate_enhanced_dag_metadata_missing_annotation(self, valid_enhanced_metadata):
    ...
    def test_validate_enhanced_dag_metadata_validation_error(self, valid_enhanced_metadata):
    ...
    def test_validate_enhanced_dag_metadata_exception(self, mock_logger, valid_enhanced_metadata):
        ...
        with patch.object(valid_enhanced_metadata, '_validate', side_effect=Exception("Validation error")):
