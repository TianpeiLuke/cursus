...
class TestRegistrySyncUtilityFunctions:
    ...
    def test_validate_registry_file_valid(
    ...
    def test_validate_registry_file_orphaned_connections(
        self, temp_registry_path, sample_registry_data
    ):
        """Test validate_registry_file with orphaned connections."""
        # Add orphaned connection
        sample_registry_data["nodes"]["xgb_simple_training"]["connections"][
            "alternatives"
    ...
    def test_validate_registry_file_tag_index_inconsistency(
        self, temp_registry_path, sample_registry_data
    ):
        """Test validate_registry_file with tag index inconsistency."""
        # Add reference to non-existent pipeline in tag index
        sample_registry_data["tag_index"]["framework_tags"]["pytorch"] = [
