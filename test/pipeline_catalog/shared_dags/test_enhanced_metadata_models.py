...
class TestZettelkastenMetadata:
    ...
    def test_zettelkasten_metadata_defaults(self):
        ...
        zm = ZettelkastenMetadata(
            atomic_id="test_pipeline", single_responsibility="Test functionality"
        )
        ...
        assert zm.pattern_tags == [
            "atomic_workflow",
            "independent",
        ]  # Default pattern tags

    def test_validate_atomic_id(self):
        """Test atomic_id validation."""
        # Valid atomic_id
        zm = ZettelkastenMetadata(atomic_id="valid_id", single_responsibility="Test")
        ...
        with pytest.raises(ValueError, match="atomic_id must be a non-empty string"):
            ZettelkastenMetadata(atomic_id="", single_responsibility="Test")
    ...
    def test_validate_single_responsibility_verbose(self):
        ...
        with patch(
            ...
            zm = ZettelkastenMetadata(
                atomic_id="test_pipeline", single_responsibility=verbose_responsibility
            )
    ...
    def test_add_connection(self, sample_zettelkasten_metadata):
        ...
        assert (
            zm.curated_connections["pytorch_simple_training"]
