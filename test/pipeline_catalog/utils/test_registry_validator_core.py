...
class TestRegistryValidatorCore:
    ...
    def mock_registry(self):
        ...
        registry_data = {
            ...
            "tag_index": {
                ...
                "task_tags": {"training": ["valid_pipeline", "related_pipeline"]},
                "complexity_tags": {
        ...
        registry.get_pipeline_connections.side_effect = lambda pid: valid_nodes.get(
            pid, {}
        ).get("connections", {})
    ...
    def test_validate_connections_missing_annotation(self, validator):
        ...
        invalid_connections = {
            "alternatives": [],
            "related": [
                {"id": "related_pipeline", "annotation": ""}
            ],  # Empty annotation
            "used_in": [],
        }
    ...
    def test_validate_connections_self_reference(self, validator):
        ...
        invalid_connections = {
            "alternatives": [],
            "related": [
                {"id": "valid_pipeline", "annotation": "Self reference"}
            ],  # Self-reference
            "used_in": [],
        }
    ...
    def test_generate_validation_report_system_error(self, validator):
        ...
        with patch.object(
            validator, "validate_atomicity", side_effect=Exception("System error")
        ):
            report = validator.generate_validation_report()
    ...
    def test_are_similar_tags(self, validator):
        ...
        assert validator._are_similar_tags(
