...
class TestValidationFunctions(unittest.TestCase):
    ...
    def test_validate_file_name_no_violations(self):
        ...
        self.assertEqual(result, 0)
        self.mock_validator.validate_file_naming.assert_called_once_with("test_file.py", "builder")
        output = self.mock_stdout.getvalue()
    ...
    def test_validate_file_name_with_violations(self):
        ...
        violations = [NamingViolation("test_file.py", "invalid_name", "Invalid file name")]
    ...
    def test_validate_step_name_no_violations(self):
        ...
        self.assertEqual(result, 0)
        self.mock_validator._validate_canonical_step_name.assert_called_once_with("XGBoostTraining", "CLI")
        output = self.mock_stdout.getvalue()
    ...
    def test_validate_step_name_with_violations(self):
        ...
        violations = [NamingViolation("XGBoostTraining", "invalid_case", "Invalid case")]
        self.mock_validator._validate_canonical_step_name.return_value = violations
        
        result = validate_step_name("xgboost_training")
        
        self.assertEqual(result, 1)
        self.mock_validator._validate_canonical_step_name.assert_called_once_with("xgboost_training", "CLI")
    ...
    def test_validate_logical_name_no_violations(self):
        ...
        self.assertEqual(result, 0)
        self.mock_validator._validate_logical_name.assert_called_once_with("input_data", "CLI")
        output = self.mock_stdout.getvalue()
    ...
    def test_validate_logical_name_with_violations(self):
        ...
        violations = [NamingViolation("inputData", "invalid_case", "Should be snake_case")]
...
class TestMainFunction(unittest.TestCase):
    ...
    def test_main_file_command_verbose(self):
        ...
        self.assertEqual(result, 0)
        self.mock_validate_file_name.assert_called_once_with('test_file.py', 'builder', True)
    ...
    def test_main_file_command_with_violations(self):
        ...
        self.assertEqual(result, 1)
        self.mock_validate_file_name.assert_called_once_with('invalid_file.py', 'config', False)
        output = self.mock_stdout.getvalue()
    ...
    def test_main_logical_command_with_violations(self):
        ...
        self.assertEqual(result, 1)
        self.mock_validate_logical_name.assert_called_once_with('invalidLogicalName', False)
        output = self.mock_stdout.getvalue()
        self.assertIn("⚠️  Found 1 violation(s)", output)
    ...
    def test_main_invalid_command(self):
        ...
        with self.assertRaises(SystemExit) as cm:
            main()
        self.assertEqual(cm.exception.code, 2)  # argparse exits with code 2 for invalid arguments
